...
public class Provider extends ContentProvider {
    ...
    public static final class Constants implements BaseColumns {
        public static final Uri CONTENT_URI =
                Uri.parse("content://ru.ifmo.md.exam0.Provider/constants");
        public static final String DEFAULT_SORT_ORDER = "_id";
        public static final String TITLE = "title";
        public static final String VALUE = "value";
        public static final String STASH = "stash";
        public static final String ROUBLE = "rouble";
        public static final String SUM = "sum";
    }
    static {
        MATCHER = new UriMatcher(UriMatcher.NO_MATCH);
        MATCHER.addURI("ru.ifmo.md.exam0.Provider", "constants", CONSTANTS);
        MATCHER.addURI("ru.ifmo.md.exam0.Provider", "constants/#", CONSTANT_ID);
    }
    @Override
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        throw new SQLiteException("Failed to insert raw into: " + uri);
    }
